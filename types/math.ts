...
type LastItem<T extends unknown[]> = T extends [...infer _, infer Last]
  ? Last
  : never;
...
type NthLastItem<T extends any[], N extends number> = N extends 0
  ? never
...
type SmallerNumber<N extends number> = N extends 0
  ? 0
  : N extends 1
    ? 0
    : Subtract<N, 2>;
...
export type Subtract<N extends number, M extends number> = NthLastItem<
  Enumerate<N>,
  M
>;
